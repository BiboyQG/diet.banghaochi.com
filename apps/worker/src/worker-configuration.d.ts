/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1b5d483e8761d107262c64feb8796672)
// Runtime types generated with workerd@1.20260611.1 2026-06-14 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "staging" | "production" | "local";
	IOS_AUTH_CALLBACK_URL: "diettracker://access/callback";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "IOS_AUTH_CALLBACK_URL">> {}
}
